...
export const project_rapp_key_value = [];
project_rapp_key_value[0] = '0 Rapp envoyer';
project_rapp_key_value[1] = '1 Rapp envoyer';
project_rapp_key_value[2] = '2 Rapp envoyer';
project_rapp_key_value[3] = '3 Rapp envoyer';
...
export const stop_loading_url = [
    environment.apiUrl + '/api/timer-logs',
	environment.apiUrl + '/api/get-notifications',
	environment.apiUrl + '/api/notifications/delete'
];
