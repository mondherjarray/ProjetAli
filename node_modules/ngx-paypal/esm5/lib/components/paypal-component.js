...
var NgxPaypalComponent = /** @class */ (function () {
    ...
    function (changes) {
        ...
        if (config) {
             ...
             * @return {?}
             */
            function (paypal) { return _this.initPayPal(config, paypal); }));
        }
    };
    /**
     * @return {?}
